...
labe1=tk.Label(root,text="Enter your text:",font="Helvatica 15 bold")
labe1.pack(pady=10)
...
button_exit=tk.Button(root,text="Exit",bg="red",fg="black",font="Helvatica 10 bold",padx=10,pady=3,command=exit_program)
button_exit.pack(pady=5)
button_exit.place(x=200,y=230)

button_set=tk.Button(root,text="Set",bg="cyan",fg="black",font="Helvatica 10 bold",padx=10,pady=3,command=clear_text)
